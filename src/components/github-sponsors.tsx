    ...
    return (
      <div className="w-full rounded-xl border border-border bg-card p-6">
        <div className="flex items-center gap-2 mb-4">
          ...
          <h3 className="text-xl font-bold">{t.sponsors.loading}</h3>
        </div>
    ...
    return (
      <div className="w-full rounded-xl border border-red-500/20 bg-card p-6">
        <div className="flex items-center gap-2 mb-4">
          ...
          <h3 className="text-xl font-bold text-red-500">{t.sponsors.error}</h3>
        </div>
        ...
        {debug && (
          <details className="text-xs text-muted-foreground mt-2">
            <summary className="cursor-pointer">{t.sponsors.debug}</summary>
      ...
      <div className="relative w-full rounded-xl border border-border bg-card overflow-hidden group">
        ...
        <div className="p-6">
          <div className="flex items-center gap-2 mb-4">
            ...
            <h3 className="text-xl font-bold">{t.sponsors.become}</h3>
          </div>
      ...
      <div className="p-6">
        <div className="flex items-center gap-2 mb-4">
          ...
          <h3 className="text-xl font-bold">
            {t.sponsors.title} {sponsors.length > 0 && `(${sponsors.length})`}
          </h3>
        </div>
